...
export class Migration1651500740770 implements MigrationInterface {
    name = 'Migration1651500740770'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`agent_role\` CHANGE \`creator_id\` \`creator_id\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`career\` CHANGE \`creator_id\` \`creator_id\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`agent\` CHANGE \`creator_id\` \`creator_id\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`creator_id\` \`creator_id\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`file\` CHANGE \`creator_id\` \`creator_id\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`operation\` CHANGE \`creator_id\` \`creator_id\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`client_operation_type\` CHANGE \`creator_id\` \`creator_id\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`operation_type\` CHANGE \`creator_id\` \`creator_id\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`company\` CHANGE \`creator_id\` \`creator_id\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`work_field\` CHANGE \`creator_id\` \`creator_id\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`licence\` CHANGE \`creator_id\` \`creator_id\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`company_category\` CHANGE \`creator_id\` \`creator_id\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`account\` CHANGE \`creator_id\` \`creator_id\` int NOT NULL`);
