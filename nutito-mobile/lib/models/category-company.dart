...
class CategoryCompany {
  ...
  factory CategoryCompany.fromMap(Map<String, dynamic> map) {
    return CategoryCompany(
      id: map['id']?.toInt(),
      name: map['name'],
  ...
  factory CategoryCompany.fromJson(String source) =>
      CategoryCompany.fromMap(json.decode(source));

  @override
  String toString() {
    return 'CategoryCompany(id: $id, name: $name, description: $description, createur_id: $createur_id, editeur_id: $editeur_id, create_at: $create_at, update_at: $update_at)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is CategoryCompany &&
        other.id == id &&
        other.name == name &&
